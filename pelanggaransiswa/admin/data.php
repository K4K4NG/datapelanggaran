...
<body id="body-pd">
            ...
            if (mysqli_num_rows($result) > 0) {
                while ($tampil = mysqli_fetch_array($result)) {
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo $tampil['kelas_siswa']; ?>
                        </td>
                        <td>
                            <?php echo $tampil['nisn_siswa']; ?>
                        </td>
                        <td>
                            <a href="edit.php?id=<?php echo $tampil['id']; ?>" class="btn btn-sm btn-primary"><i
                                    class="fa fa-edit"></i></a>
                            <a href="hapus.php?id=<?php echo $tampil["id"]; ?>" class="btn btn-sm btn-danger"><i
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            const sortTable = (columnIndex, reverse) => {
                rows.sort((a, b) => {
            ...
            // Tambahkan event listener untuk setiap tombol sorting
